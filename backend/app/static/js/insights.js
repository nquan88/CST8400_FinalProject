  ...
  try {
    ...
    if (!result || !result.analytics) {
      container.innerHTML = `
        <div class="empty-state">
          <div class="empty-icon">⚠️</div>
          <p>Failed to load analytics summary.</p>
        </div>`;
      return;
    }
      ...
      <div class="insights-grid">
        ...
        <div class="insight-card info">
          <div class="insight-body">
            ...
            <p>${escHtml(a.preferred_reading_time ?? 'N/A')}</p>
          </div>
        </div>
        ...
        <div class="insight-card info">
          <div class="insight-body">
            ...
            <p>${a.avg_duration_minutes ?? 0} minutes</p>
          </div>
        </div>
        ...
        <div class="insight-card info">
          <div class="insight-body">
            ...
            <p>
              Short: ${a.session_duration_patterns?.Short ?? 0}<br>
              Medium: ${a.session_duration_patterns?.Medium ?? 0}<br>
              Long: ${a.session_duration_patterns?.Long ?? 0}
            </p>
          </div>
        </div>
    ...
    container.innerHTML = `
      <div class="empty-state">
        <div class="empty-icon">⚠️</div>
        <p>Could not load analytics summary.</p>
      </div>`;
  }
}
